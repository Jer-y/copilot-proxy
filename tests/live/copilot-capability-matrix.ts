import type { AnthropicMessagesPayload, AnthropicResponse, AnthropicToolUseBlock } from '~/lib/anthropic/types'
...
export const copilotCapabilityProbes: Array<CapabilityProbe> = [
  {
    ...
    tier: 'baseline',
    endpoint: 'chat-completions',
    candidateFix: 'Native Chat Completions access for the selected Claude model.',
    candidateMapping: 'Chat Completions request -> Copilot /chat/completions',
  ...
  },
  {
    ...
    tier: 'baseline',
    endpoint: 'responses',
    candidateFix: 'Validate whether the selected Claude model has a native Responses endpoint; never translate an incompatible request.',
    candidateMapping: 'Claude model -> Copilot /responses',
    rationale: 'Check native Responses eligibility independently from the selected model name or bundled policy.',
  ...
  },
  {
    ...
    tier: 'baseline',
    endpoint: 'responses',
    candidateFix: 'Native Responses access for the selected model.',
    candidateMapping: 'Responses request -> Copilot /responses',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'chat-completions',
    candidateFix: 'Forward native Chat Completions tool_choice when the selected upstream accepts it.',
    candidateMapping: 'Chat Completions tool_choice -> Copilot /chat/completions',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'chat-completions',
    candidateFix: 'Validate native Chat Completions parallel_tool_calls=false support.',
    candidateMapping: 'Chat Completions parallel_tool_calls=false -> Copilot /chat/completions',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'chat-completions',
    candidateFix: 'Validate native Chat Completions reasoning_effort=high support.',
    candidateMapping: 'Chat Completions reasoning_effort=high -> Copilot /chat/completions',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'chat-completions',
    candidateFix: 'Validate native Chat Completions reasoning_effort=max support.',
    candidateMapping: 'Chat Completions reasoning_effort=max -> Copilot /chat/completions',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'responses',
    candidateFix: 'Validate native Responses reasoning.effort=low support.',
    candidateMapping: 'Responses reasoning.effort=low -> Copilot /responses',
    rationale: 'Check low effort independently from other native Responses reasoning settings.',
    expectation: 'support_or_clean_unsupported',
    isUnsupported: buildUnsupportedMatcher([
      'reasoning',
      'effort',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'responses',
    candidateFix: 'Validate native Responses reasoning.effort=medium support.',
    candidateMapping: 'Responses reasoning.effort=medium -> Copilot /responses',
    rationale: 'Validate the native Responses medium-effort setting.',
    expectation: 'support_or_clean_unsupported',
    isUnsupported: buildUnsupportedMatcher([
      'reasoning',
      'effort',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'responses',
    candidateFix: 'Validate native Responses reasoning.effort=high support.',
    candidateMapping: 'Responses reasoning.effort=high -> Copilot /responses',
    rationale: 'Validate the native Responses high-effort setting.',
    expectation: 'support_or_clean_unsupported',
    isUnsupported: buildUnsupportedMatcher([
      'reasoning',
      'effort',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'responses',
    candidateFix: 'Validate native Responses reasoning.effort=xhigh without remapping another protocol.',
    candidateMapping: 'Responses reasoning.effort=xhigh -> Copilot /responses',
    rationale: 'Validate the selected Responses model against the exact requested effort value.',
    expectation: 'must_support',
    isUnsupported: buildUnsupportedMatcher([
      'reasoning',
      'effort',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'responses',
    candidateFix: 'Validate native Responses parallel_tool_calls=false behavior.',
    candidateMapping: 'Responses parallel_tool_calls=false -> Copilot /responses',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'chat-completions',
    candidateFix: 'Validate native Chat Completions response_format=json_object support.',
    candidateMapping: 'Chat Completions response_format=json_object -> Copilot /chat/completions',
    rationale: 'Validate the json_object switch on the selected native Chat Completions endpoint.',
    expectation: 'support_or_clean_unsupported',
    isUnsupported: buildUnsupportedMatcher([
      'response_format',
      'response format',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'chat-completions',
    candidateFix: 'Keep this probe native to Chat Completions; schema enforcement requires semantic validation, not only parameter acceptance.',
    candidateMapping: 'Direct Copilot chat-completions response_format=json_schema probe only.',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'responses',
    candidateFix: 'Validate native Responses text.format=json_object support.',
    candidateMapping: 'Responses text.format=json_object -> Copilot /responses',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'responses',
    candidateFix: 'Validate native Responses text.format=json_schema support.',
    candidateMapping: 'Responses text.format=json_schema -> Copilot /responses',
  ...
  },
  {
    ...
    tier: 'optional',
    endpoint: 'responses',
    candidateFix: 'Validate native Responses external image URL support.',
    candidateMapping: 'Responses input_image.image_url -> Copilot /responses',
